                        ...
                        <td class="wrap">
                            <?php if ($sStatus !== 'paid'): ?>
                                <div class="table-actions">
                                    <button type="button" class="btn btn-primary btn-sm btn-icon" onclick="document.getElementById('payout-modal-<?= $schedId ?>').style.display='block'" title="Jana Payout" aria-label="Jana Payout">
